...
# sys.path.insert(1, join(abspath(dirname(__file__)), 'mqc'))
# import json 
# from utils import *
...
#         controler = preprocessing_control.Preprocess(file_path)
#         model_pre_process = model_control.ModelPreprocess()
#         model_pre_process.get_model_info(controler)
#         nets = net_control.Nets()
